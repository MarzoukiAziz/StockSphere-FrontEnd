...
class FournisseurService extends __BaseService {
  static readonly findAllPath = '/stockmanagement/v1/fournisseurs/all';
  static readonly savePath = '/stockmanagement/v1/fournisseurs/create';
  static readonly deletePath =
    '/stockmanagement/v1/fournisseurs/delete/{idFournisseur}';
  static readonly findByIdPath =
    '/stockmanagement/v1/fournisseurs/{idFournisseur}';
  ...
  findAllResponse(): __Observable<__StrictHttpResponse<Array<FournisseurDto>>> {
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/stockmanagement/v1/fournisseurs/all`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  saveResponse(
    body?: FournisseurDto
  ): __Observable<__StrictHttpResponse<FournisseurDto>> {
    let __params = this.newParams();
    let __headers = new HttpHeaders();
    let __body: any = null;
    __body = body;
    let req = new HttpRequest<any>(
      'POST',
      this.rootUrl + `/stockmanagement/v1/fournisseurs/create`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  deleteResponse(
    ...
    let req = new HttpRequest<any>(
      'DELETE',
      this.rootUrl + `/stockmanagement/v1/fournisseurs/delete/${idFournisseur}`,
      __body,
      {
        headers: __headers,
        params: __params,
  ...
  findByIdResponse(
    ...
    let req = new HttpRequest<any>(
      'GET',
      this.rootUrl + `/stockmanagement/v1/fournisseurs/${idFournisseur}`,
      __body,
      {
        headers: __headers,
        params: __params,
